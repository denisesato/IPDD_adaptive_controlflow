...
def define_change_points(inter_drift_distance):
...
if __name__ == '__main__':
    ...
    actual_change_points = {
        '2.5k': define_change_points(250),
        '5k': define_change_points(500),
        '7.5k': define_change_points(750),
        '10k': define_change_points(1000)
    }
