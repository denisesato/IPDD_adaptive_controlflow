...
def calculate_metrics_for_dataset(dataset_config, dataset_name):
    ...
    prodrift_filepath = f'E:/Doutorado_Experimentos/Apromore/experimento2/{dataset_name}'
    ...
    vdd_filepath = f'E:/Doutorado_Experimentos/VDD/experimento2/{dataset_name}/output_console'
