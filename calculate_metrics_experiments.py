...
def calculate_metrics_for_dataset(dataset_config, dataset_name):
    # ipdd_quality_trace_path = f'data//output//controlflow_adaptive//detection_on_quality_metrics_trace_by_trace' \
    #                           f'//{dataset_name}'
    ...
    #
    # ipdd_quality_windowing_path = f'data//output//controlflow_adaptive//detection_on_quality_metrics_fixed_window' \
    #                               f'//{dataset_name}'
    ...
    # ipdd_model_similarity_path = f'data//output//controlflow_adaptive//detection_on_model_similarity_fixed_window' \
    #                              f'//{dataset_name}'
    ...
    # prodrift_filepath = f'C://Users//denis//Documents//Doutorado_Experimentos//Apromore//{dataset_name}'
    ...
    # vdd_filepath = f'C://Users//denisesato//Experimentos_Tese//VDD//{dataset_name}//output_console'
    vdd_filepath = f'D://Doutorado_Experimentos//VDD//experimento2//{dataset_name}//output_console'
